...
const authorizeSpotify = (req, res) => {
    ...
    const scope2 = 'playlist-modify-public playlist-modify-private playlist-read-private playlist-read-collaborative'
    const scope3 = 'user-follow-modify user-follow-read  user-read-email user-read-private';
